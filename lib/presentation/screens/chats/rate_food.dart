            ...
            Stack(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Center(child: Image.asset('assets/rate2.png')),
                    SizedBox(
                      height: 1.h,
                    ),
                    Center(child: Text('    Thank You!\nEnjoy Your Meal',style: TextStyle(
                        fontSize: 17.sp,
                    ...
                    Center(
                      child: Text('Please rate your food',style: TextStyle(
                          color: Colors.grey
                      ),),
                    ),
                    SizedBox(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            decoration: InputDecoration(
                                ...
                                prefixIcon: Icon(Icons.edit_road_rounded,color: secondLinear,),
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              ...
                              child: InkWell(
                                onTap: (){
                                  Navigator.pushNamed(context, screens.rateRestaurantScreen);
